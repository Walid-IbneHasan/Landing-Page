const AboutSection = () => {
  return (
    <section className="relative">
      ...
      <div className="absolute top-0 left-0 grid grid-cols-1 lg:grid-cols-2 w-full h-full xl:place-content-center">
        <div className="lg:col-start-2 p-4 lg:pt-[10px]  lg:w-full xl:w-[736px]">
          ...
          <p className="text-[#CFCFCF] text-[8px] md:text-[14px] 2xl:text-[18px] ">
            ...
            <span className="text-[#FCD64E]">Green Shark Limited</span> to
            prompt a technological innovation and to positively alter the
            financial industry practice and the life of people. The ways to use
            “Money” are below observed and divided into three categories: 1.
            Fund Transfer; 2. Payment and 3. Currency Exchanges.
          </p>
